...
- **A DOI-resolver-verified check of the QCEC and Bugs4Q journal citations** (currently verified only via repo citation blocks / citing papers, not independently opened) — needed for publication-quality bibliographic rigor.
