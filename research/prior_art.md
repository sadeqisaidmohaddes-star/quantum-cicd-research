...
| **Bugs4Q / Bugs4Q-Robust** | Bug corpus | YES | YES | Qiskit | — | — | — | — | — | — | NO | NO | — | — | — | YES (36 bugs per 2021 preprint; 42 per DOI-confirmed JSS 2023 published version) | NO | NO | NO | arXiv:2108.09744; DOI 10.1016/j.jss.2023.111805; github.com/Z-928/Bugs4Q | Reusable corpus, not a CI tool itself |
...
1. **Bugs4Q** (arXiv 2108.09744, 2021 preprint: 36 manually-validated real Qiskit bugs spanning Terra/Aer/Ignis/Aqua, with buggy+fixed code and reproducing tests; journal version *JSS* vol. 205, 2023, DOI 10.1016/j.jss.2023.111805 — **independently confirmed via ACM DL's listing in verification pass 2 (2026-08-20)**, exact title "Bugs4Q: A benchmark of existing bugs to enable controlled testing and debugging studies for quantum programs," describing **42 real bugs mined from GitHub, StackOverflow, and Stack Exchange**). The earlier "~50–67 entries under Bugs4Q-NA" figure from pass 1 could not be re-confirmed and is now flagged UNVERIFIED — cite 36 (preprint) or 42 (JSS 2023) instead. Public repo: github.com/Z-928/Bugs4Q. Described in a 2026 replication study as "a widely used dataset of real-world bugs in quantum programs."
